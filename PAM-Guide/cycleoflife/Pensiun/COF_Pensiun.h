...
@interface COF_Pensiun : UIViewController <CKCalendarDelegate,UIGestureRecognizerDelegate> {
    ...
    IBOutlet UISlider *usiapensiun;
    IBOutlet UISlider *saatini;
    IBOutlet UISlider *ekspetasi;
