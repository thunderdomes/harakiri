...
@interface COF_Pensiun () 

@end

@implementation COF_Pensiun
...
//    [isianBungaPinjaman setMaximumTrackImage:maxImage forState:UIControlStateNormal];
    ...
    [usiapensiun addGestureRecognizer:panGesture];
    [saatini addGestureRecognizer:panGesture];
    [ekspetasi addGestureRecognizer:panGesture];
