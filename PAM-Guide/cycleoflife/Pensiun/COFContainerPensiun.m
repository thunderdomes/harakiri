...
#import "COFContainerPensiun.h"
#import "COF_Pensiun.h"

@interface COFContainerPensiun ()

@end

@implementation COFContainerPensiun
...
- (UIViewController*)configurePage:(NSUInteger)index
{
    ...
    else
    {
        ...
        switch (index+1) {
            case 1:
                self.Form = [[COF_Pensiun alloc] initWithNibName:@"COF_Pensiun" bundle:nil] ;
                break;
            case 2:
                 self.Form = [[COF_Pensiun alloc] initWithNibName:@"COF_Pensiun1" bundle:nil] ;
                break;
            case 3:
                self.Form = [[COF_Pensiun alloc] initWithNibName:@"COF_Pensiun2" bundle:nil];
                break;
            case 4:
                self.Form = [[COF_Pensiun alloc] initWithNibName:@"COF_Pensiun3" bundle:nil];
                break;
            case 5:
                self.Form = [[COF_Pensiun alloc] initWithNibName:@"COF_Pensiun4" bundle:nil];
                break;
            case 6:
                self.Form = [[COF_Pensiun alloc] initWithNibName:@"COF_Pensiun5" bundle:nil];
                break;
            case 7:
                self.Form = [[COF_Pensiun alloc] initWithNibName:@"COF_Pensiun6" bundle:nil];
                break;
            default:
                self.Form = nil;
                break;
