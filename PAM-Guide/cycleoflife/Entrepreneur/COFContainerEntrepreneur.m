...
@interface COFContainerEntrepreneur ()

@end

@implementation COFContainerEntrepreneur
...
- (UIViewController*)configurePage:(NSUInteger)index
{
    ...
    else
    {
        ...
        switch (index+1) {
            case 1:
                self.Form = [[COF_Entrepreneur alloc] initWithNibName:@"COF_Entrepreneur" bundle:nil] ;
                break;
            case 2:
                 self.Form = [[COF_Entrepreneur alloc] initWithNibName:@"COF_Entrepreneur1" bundle:nil] ;
                break;
            case 3:
                self.Form = [[COF_Entrepreneur alloc] initWithNibName:@"COF_Entrepreneur2" bundle:nil];
                break;
            case 4:
                self.Form = [[COF_Entrepreneur alloc] initWithNibName:@"COF_Entrepreneur3" bundle:nil];
                break;
            case 5:
                self.Form = [[COF_Entrepreneur alloc] initWithNibName:@"COF_Entrepreneur4" bundle:nil];
                break;
            case 6:
                self.Form = [[COF_Entrepreneur alloc] initWithNibName:@"COF_Entrepreneur5" bundle:nil];
                break;
            default:
                self.Form = nil;
                break;
