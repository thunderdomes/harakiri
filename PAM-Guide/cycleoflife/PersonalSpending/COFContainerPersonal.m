...
#import "COFContainerPersonal.h"
#import "COF_Personal.h"

@interface COFContainerPersonal ()

@end

@implementation COFContainerPersonal
...
- (UIViewController*)configurePage:(NSUInteger)index
{
    ...
    else
    {
        ...
        switch (index+1) {
            case 1:
                self.Form = [[COF_Personal alloc] initWithNibName:@"COF_Personal" bundle:nil] ;
                break;
            case 2:
                 self.Form = [[COF_Personal alloc] initWithNibName:@"COF_Personal1" bundle:nil] ;
                break;
            case 3:
                self.Form = [[COF_Personal alloc] initWithNibName:@"COF_Personal2" bundle:nil];
                break;
            case 4:
                self.Form = [[COF_Personal alloc] initWithNibName:@"COF_Personal3" bundle:nil];
                break;
            case 5:
                self.Form = [[COF_Personal alloc] initWithNibName:@"COF_Personal4" bundle:nil];
                break;
            case 6:
                self.Form = [[COF_Personal alloc] initWithNibName:@"COF_Personal5" bundle:nil];
                break;
            default:
                self.Form = nil;
                break;
