...
#import "COFContainerRumah.h"
#import "MBProgressHUD.h"
#import "COFKendaraan.h"
#import "COFRumah.h"

@interface COFContainerRumah ()

@end

@implementation COFContainerRumah
...
- (UIViewController*)configurePage:(NSUInteger)index
{
    ...
    else
    {
        ...
        switch (index+1) {
            case 1:
                self.Form = [[COFRumah alloc] initWithNibName:@"COF_Rumah" bundle:nil] ;
                break;
            case 2:
                 self.Form = [[COFRumah alloc] initWithNibName:@"COF_Rumah2" bundle:nil] ;
                break;
            case 3:
                self.Form = [[COFRumah alloc] initWithNibName:@"COF_Rumah3" bundle:nil];
                break;
            case 4:
                self.Form = [[COFRumah alloc] initWithNibName:@"COF_Rumah4" bundle:nil];
                break;
            case 5:
                self.Form = [[COFRumah alloc] initWithNibName:@"COF_Rumah5" bundle:nil];
                break;
            case 6:
                self.Form = [[COFRumah alloc] initWithNibName:@"COF_Rumah6" bundle:nil];
                break;
            case 7:
                self.Form = [[COFRumah alloc] initWithNibName:@"COF_Rumah7" bundle:nil];
                break;
            case 8:
                self.Form = [[COFRumah alloc] initWithNibName:@"COF_Rumah8" bundle:nil];
                break;
            default:
                self.Form = nil;
                break;
